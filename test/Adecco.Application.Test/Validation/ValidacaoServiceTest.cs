...
public class ValidacaoServiceTest
{
    ...
    public void ValidarTelefone_DeveValidarTelefoneCorretamente(
        int ddd,
        string telefone,
    ...
    [InlineData(
        ...
        "",
        "",
        ETipoEndereco.Preferencial,
        false
    )]
    public void ValidarEndereco_DeveValidarEnderecoCorretamente(
        int id,
        string nome,
        string cep,
        string logradouro,
    ...
    public void ValidarContato_DeveValidarContatoCorretamente(
        int id,
        string nome,
        int ddd,
        decimal telefone,
    ...
    public void ValidarCliente_DeveValidarClienteCorretamente()
    {
        var contatos = new List<Contato>
        {
            new Contato(
                ...
                dDD: 11,
                telefone: 999999999M,
                tipoContato: ETipoContato.Celular
            )
        };
        ...
        var enderecos = new List<Endereco>
        {
            new Endereco(
                ...
                cidade: "Cidade",
                estado: "SP",
                referencia: "Perto de algo",
                tipoEndereco: ETipoEndereco.Cobranca
            )
        };
